...
(function (global, factory) {
	...
	*/
	...
	(function ($) {
	  ...
	  $(function () {
	    // Autofill
	    if ($('#gform_1').length || $('#gform_5').length || $('#gform_10').length || $('#gform_11').length || $('#gform_12').length || $('#gform_13').length || $('#gform_14').length || $('#gform_15').length || $('#gform_16').length || $('#gform_17').length || $('#gform_18').length || $('#gform_19').length || $('#gform_20').length || $('#gform_21').length || $('#gform_22').length || $('#gform_24').length || $('#gform_25').length) {
	      if ($('#gform_1').length || $('#gform_5').length || $('#gform_10').length || $('#gform_11').length || $('#gform_12').length || $('#gform_13').length || $('#gform_14').length || $('#gform_15').length || $('#gform_16').length || $('#gform_17').length || $('#gform_18').length || $('#gform_19').length || $('#gform_20').length || $('#gform_21').length || $('#gform_22').length || $('#gform_24').length || $('#gform_25').length) {
	...
	})(window.jQuery); // Gravity forms side 2


	jQuery(document).on('gform_page_loaded', function (event, form_id, current_page) {
	  if (current_page == 2) {
	    jQuery('#step1').hide();
	    jQuery(".gravity-forms").prepend("<div class='step2-outer'><p>Steg</p><img src='/wp-content/themes/betakaroten2.0/inc/gfx/steg_bestilling_02.svg' id='step2'></div>");
	    jQuery('.form-left').hide();
	    jQuery('.form-right2').show();
	    jQuery('#nedtelling-outer').hide();
	  }
	}); // Bestillingsknapp
	...
	jQuery(document).ready(function () {
	  ...
	  jQuery('.anm-anmeldelser').slick({
	    slidesToShow: 3,
	    slidesToScroll: 1,
	    arrows: true,
	    infinite: true,
	    "cssEase": "linear",
	    prevArrow: '<div class="slick-prev"><img src="/wp-content/themes/betakaroten2.0/blocks/prodanmeldelser/img/ikon_pil.svg"></div>',
	    nextArrow: '<div class="slick-next"><img src="/wp-content/themes/betakaroten2.0/blocks/prodanmeldelser/img/ikon_pil.svg"></div>',
	    responsive: [{
	      breakpoint: 1024,
	      settings: {
	        slidesToShow: 3,
	...
	jQuery(function () {
	  ...
	  jQuery('.marqueebanner').marquee({
	    ...
	    duplicated: true
	  }); // x personer besøker akkurat nå

	  jQuery('.cur-visit').html(Math.floor(Math.random() * (130 - 110 + 1) + 110));
	  setInterval(function () {
	    var nummer = Math.floor(Math.random() * (130 - 110 + 1) + 110);
	    jQuery('.cur-visit').html(nummer);
	  }, 8000); // Galleri
	  ...
	  jQuery('.product-carousel__thumbnail').on('click', function () {
	    jQuery('.aktiv').removeClass();
	    jQuery(this).find('img').addClass('aktiv');
	  }); // Hjerte

	  if (document.body.classList.contains('page-id-524')) {
	    // Find the first h1 inside .forsidehoved-content
	    const h1 = document.querySelector('.forsidehoved-content h1');

	    if (h1) {
	      // Ensure h1 exists to avoid errors
	      const newElement = document.createElement('div');
	      newElement.innerHTML = "<p class='heart'><i class='fa fa-heart fa-4x fa-beat'></i></p>"; // Insert the new element before the h1 element in the DOM

	      h1.parentNode.insertBefore(newElement, h1);
	    }
	  }
	}); // Popup
	...
	exports.__moduleExports = customJavascript.exports;
