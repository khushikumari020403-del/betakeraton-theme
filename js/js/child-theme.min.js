...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(){const t=new Map;return{set(e,n,i){t.has(e)||t.set(e,new Map);const s=t.get(e);(s.has(n)||0===s.size)&&s.set(n,i)},get:(e,n)=>t.has(e)&&t.get(e).get(n)||null,remove(e,n){if(!t.has(e))return;const i=t.get(e);i.delete(n),0===i.size&&t.delete(e)}}}()}(c),
/*!
...
/*!
	  ...
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n,i){const s=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},o=s(t),r=s(e),a=s(n),l=s(i),c=t=>null==t?`${t}`:{}.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase(),d=t=>{let e=t.getAttribute("data-bs-target");if(!e||"#"===e){let n=t.getAttribute("href");if(!n||!n.includes("#")&&!n.startsWith("."))return null;n.includes("#")&&!n.startsWith("#")&&(n=`#${n.split("#")[1]}`),e=n&&"#"!==n?n.trim():null}return e},u=t=>{const e=d(t);return e&&document.querySelector(e)?e:null},f=t=>!(!t||"object"!=typeof t)&&(void 0!==t.jquery&&(t=t[0]),void 0!==t.nodeType),h=t=>f(t)?t.jquery?t[0]:t:"string"==typeof t&&t.length>0?document.querySelector(t):null,p=(t,e,n)=>{Object.keys(n).forEach((i=>{const s=n[i],o=e[i],r=o&&f(o)?"element":c(o);if(!new RegExp(s).test(r))throw new TypeError(`${t.toUpperCase()}: Option "${i}" provided type "${r}" but expected type "${s}".`)}))},m=()=>{const{jQuery:t}=window;return t&&!document.body.hasAttribute("data-bs-no-jquery")?t:null},g=[],_=t=>{"loading"===document.readyState?(g.length||document.addEventListener("DOMContentLoaded",(()=>{g.forEach((t=>t()))})),g.push(t)):t()},b=t=>{_((()=>{const e=m();if(e){const n=t.NAME,i=e.fn[n];e.fn[n]=t.jQueryInterface,e.fn[n].Constructor=t,e.fn[n].noConflict=()=>(e.fn[n]=i,t.jQueryInterface)}}))},v="scrollspy",y=".bs.scrollspy",w={offset:10,method:"auto",target:""},E={offset:"number",method:"string",target:"(string|element)"},A=`activate${y}`,x=`scroll${y}`,C=`load${y}.data-api`,O="dropdown-item",T="active",j='[data-bs-spy="scroll"]',k=".nav, .list-group",L=".nav-link",S=".nav-item",$=".list-group-item",N=`${L}, ${$}, .${O}`,D=".dropdown",I=".dropdown-toggle",M="offset",P="position";class q extends l.default{constructor(t,e){super(t),this._scrollElement="BODY"===this._element.tagName?window:this._element,this._config=this._getConfig(e),this._offsets=[],this._targets=[],this._activeTarget=null,this._scrollHeight=0,o.default.on(this._scrollElement,x,(()=>this._process())),this.refresh(),this._process()}static get Default(){return w}static get NAME(){return v}refresh(){const t=this._scrollElement===this._scrollElement.window?M:P,e="auto"===this._config.method?t:this._config.method,n=e===P?this._getScrollTop():0;this._offsets=[],this._targets=[],this._scrollHeight=this._getScrollHeight(),a.default.find(N,this._config.target).map((t=>{const i=u(t),s=i?a.default.findOne(i):null;if(s){const t=s.getBoundingClientRect();if(t.width||t.height)return[r.default[e](s).top+n,i]}return null})).filter((t=>t)).sort(((t,e)=>t[0]-e[0])).forEach((t=>{this._offsets.push(t[0]),this._targets.push(t[1])}))}dispose(){o.default.off(this._scrollElement,y),super.dispose()}_getConfig(t){return(t={...w,...r.default.getDataAttributes(this._element),..."object"==typeof t&&t?t:{}}).target=h(t.target)||document.documentElement,p(v,t,E),t}_getScrollTop(){return this._scrollElement===window?this._scrollElement.pageYOffset:this._scrollElement.scrollTop}_getScrollHeight(){return this._scrollElement.scrollHeight||Math.max(document.body.scrollHeight,document.documentElement.scrollHeight)}_getOffsetHeight(){return this._scrollElement===window?window.innerHeight:this._scrollElement.getBoundingClientRect().height}_process(){const t=this._getScrollTop()+this._config.offset,e=this._getScrollHeight(),n=this._config.offset+e-this._getOffsetHeight();if(this._scrollHeight!==e&&this.refresh(),t>=n){const t=this._targets[this._targets.length-1];this._activeTarget!==t&&this._activate(t)}else{if(this._activeTarget&&t<this._offsets[0]&&this._offsets[0]>0)return this._activeTarget=null,void this._clear();for(let e=this._offsets.length;e--;)this._activeTarget!==this._targets[e]&&t>=this._offsets[e]&&(void 0===this._offsets[e+1]||t<this._offsets[e+1])&&this._activate(this._targets[e])}}_activate(t){this._activeTarget=t,this._clear();const e=N.split(",").map((e=>`${e}[data-bs-target="${t}"],${e}[href="${t}"]`)),n=a.default.findOne(e.join(","),this._config.target);n.classList.add(T),n.classList.contains(O)?a.default.findOne(I,n.closest(D)).classList.add(T):a.default.parents(n,k).forEach((t=>{a.default.prev(t,`${L}, ${$}`).forEach((t=>t.classList.add(T))),a.default.prev(t,S).forEach((t=>{a.default.children(t,L).forEach((t=>t.classList.add(T)))}))})),o.default.trigger(this._scrollElement,A,{relatedTarget:t})}_clear(){a.default.find(N,this._config.target).filter((t=>t.classList.contains(T))).forEach((t=>t.classList.remove(T)))}static jQueryInterface(t){return this.each((function(){const e=q.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t]()}}))}}return o.default.on(window,C,(()=>{a.default.find(j).forEach((t=>new q(t)))})),b(q),q}(a.exports,p.exports,m.exports,l.exports)}(re);var ae=re.exports,le={exports:{}};
/*!
	  * Bootstrap tab.js v5.1.3 (https://getbootstrap.com/)
	  * Copyright 2011-2021 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n){const i=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},s=i(t),o=i(e),r=i(n),a=t=>{let e=t.getAttribute("data-bs-target");if(!e||"#"===e){let n=t.getAttribute("href");if(!n||!n.includes("#")&&!n.startsWith("."))return null;n.includes("#")&&!n.startsWith("#")&&(n=`#${n.split("#")[1]}`),e=n&&"#"!==n?n.trim():null}return e},l=t=>{const e=a(t);return e?document.querySelector(e):null},c=t=>!t||t.nodeType!==Node.ELEMENT_NODE||!!t.classList.contains("disabled")||(void 0!==t.disabled?t.disabled:t.hasAttribute("disabled")&&"false"!==t.getAttribute("disabled")),d=t=>{t.offsetHeight},u=()=>{const{jQuery:t}=window;return t&&!document.body.hasAttribute("data-bs-no-jquery")?t:null},f=[],h=t=>{"loading"===document.readyState?(f.length||document.addEventListener("DOMContentLoaded",(()=>{f.forEach((t=>t()))})),f.push(t)):t()},p=t=>{h((()=>{const e=u();if(e){const n=t.NAME,i=e.fn[n];e.fn[n]=t.jQueryInterface,e.fn[n].Constructor=t,e.fn[n].noConflict=()=>(e.fn[n]=i,t.jQueryInterface)}}))},m="tab",g=".bs.tab",_=`hide${g}`,b=`hidden${g}`,v=`show${g}`,y=`shown${g}`,w=`click${g}.data-api`,E="dropdown-menu",A="active",x="fade",C="show",O=".dropdown",T=".nav, .list-group",j=".active",k=":scope > li > .active",L='[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]',S=".dropdown-toggle",$=":scope > .dropdown-menu .active";class N extends r.default{static get NAME(){return m}show(){if(this._element.parentNode&&this._element.parentNode.nodeType===Node.ELEMENT_NODE&&this._element.classList.contains(A))return;let t;const e=l(this._element),n=this._element.closest(T);if(n){const e="UL"===n.nodeName||"OL"===n.nodeName?k:j;t=o.default.find(e,n),t=t[t.length-1]}const i=t?s.default.trigger(t,_,{relatedTarget:this._element}):null;if(s.default.trigger(this._element,v,{relatedTarget:t}).defaultPrevented||null!==i&&i.defaultPrevented)return;this._activate(this._element,n);const r=()=>{s.default.trigger(t,b,{relatedTarget:this._element}),s.default.trigger(this._element,y,{relatedTarget:t})};e?this._activate(e,e.parentNode,r):r()}_activate(t,e,n){const i=(!e||"UL"!==e.nodeName&&"OL"!==e.nodeName?o.default.children(e,j):o.default.find(k,e))[0],s=n&&i&&i.classList.contains(x),r=()=>this._transitionComplete(t,i,n);i&&s?(i.classList.remove(C),this._queueCallback(r,t,!0)):r()}_transitionComplete(t,e,n){if(e){e.classList.remove(A);const t=o.default.findOne($,e.parentNode);t&&t.classList.remove(A),"tab"===e.getAttribute("role")&&e.setAttribute("aria-selected",!1)}t.classList.add(A),"tab"===t.getAttribute("role")&&t.setAttribute("aria-selected",!0),d(t),t.classList.contains(x)&&t.classList.add(C);let i=t.parentNode;if(i&&"LI"===i.nodeName&&(i=i.parentNode),i&&i.classList.contains(E)){const e=t.closest(O);e&&o.default.find(S,e).forEach((t=>t.classList.add(A))),t.setAttribute("aria-expanded",!0)}n&&n()}static jQueryInterface(t){return this.each((function(){const e=N.getOrCreateInstance(this);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t]()}}))}}return s.default.on(document,w,L,(function(t){["A","AREA"].includes(this.tagName)&&t.preventDefault(),c(this)||N.getOrCreateInstance(this).show()})),p(N),N}(a.exports,m.exports,l.exports)}(le);var ce=le.exports,de={exports:{}};
/*!
	  * Bootstrap toast.js v5.1.3 (https://getbootstrap.com/)
	  * Copyright 2011-2021 The Bootstrap Authors (https://github.com/twbs/bootstrap/graphs/contributors)
	  * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
	  */
!function(t,e){t.exports=function(t,e,n){const i=t=>t&&"object"==typeof t&&"default"in t?t:{default:t},s=i(t),o=i(e),r=i(n),a=t=>null==t?`${t}`:{}.toString.call(t).match(/\s([a-z]+)/i)[1].toLowerCase(),l=t=>{let e=t.getAttribute("data-bs-target");if(!e||"#"===e){let n=t.getAttribute("href");if(!n||!n.includes("#")&&!n.startsWith("."))return null;n.includes("#")&&!n.startsWith("#")&&(n=`#${n.split("#")[1]}`),e=n&&"#"!==n?n.trim():null}return e},c=t=>{const e=l(t);return e?document.querySelector(e):null},d=t=>!(!t||"object"!=typeof t)&&(void 0!==t.jquery&&(t=t[0]),void 0!==t.nodeType),u=(t,e,n)=>{Object.keys(n).forEach((i=>{const s=n[i],o=e[i],r=o&&d(o)?"element":a(o);if(!new RegExp(s).test(r))throw new TypeError(`${t.toUpperCase()}: Option "${i}" provided type "${r}" but expected type "${s}".`)}))},f=t=>!t||t.nodeType!==Node.ELEMENT_NODE||!!t.classList.contains("disabled")||(void 0!==t.disabled?t.disabled:t.hasAttribute("disabled")&&"false"!==t.getAttribute("disabled")),h=t=>{t.offsetHeight},p=()=>{const{jQuery:t}=window;return t&&!document.body.hasAttribute("data-bs-no-jquery")?t:null},m=[],g=t=>{"loading"===document.readyState?(m.length||document.addEventListener("DOMContentLoaded",(()=>{m.forEach((t=>t()))})),m.push(t)):t()},_=t=>{g((()=>{const e=p();if(e){const n=t.NAME,i=e.fn[n];e.fn[n]=t.jQueryInterface,e.fn[n].Constructor=t,e.fn[n].noConflict=()=>(e.fn[n]=i,t.jQueryInterface)}}))},b=(t,e="hide")=>{const n=`click.dismiss${t.EVENT_KEY}`,i=t.NAME;s.default.on(document,n,`[data-bs-dismiss="${i}"]`,(function(n){if(["A","AREA"].includes(this.tagName)&&n.preventDefault(),f(this))return;const s=c(this)||this.closest(`.${i}`);t.getOrCreateInstance(s)[e]()}))},v="toast",y=".bs.toast",w=`mouseover${y}`,E=`mouseout${y}`,A=`focusin${y}`,x=`focusout${y}`,C=`hide${y}`,O=`hidden${y}`,T=`show${y}`,j=`shown${y}`,k="fade",L="hide",S="show",$="showing",N={animation:"boolean",autohide:"boolean",delay:"number"},D={animation:!0,autohide:!0,delay:5e3};class I extends r.default{constructor(t,e){super(t),this._config=this._getConfig(e),this._timeout=null,this._hasMouseInteraction=!1,this._hasKeyboardInteraction=!1,this._setListeners()}static get DefaultType(){return N}static get Default(){return D}static get NAME(){return v}show(){if(s.default.trigger(this._element,T).defaultPrevented)return;this._clearTimeout(),this._config.animation&&this._element.classList.add(k);const t=()=>{this._element.classList.remove($),s.default.trigger(this._element,j),this._maybeScheduleHide()};this._element.classList.remove(L),h(this._element),this._element.classList.add(S),this._element.classList.add($),this._queueCallback(t,this._element,this._config.animation)}hide(){if(!this._element.classList.contains(S))return;if(s.default.trigger(this._element,C).defaultPrevented)return;const t=()=>{this._element.classList.add(L),this._element.classList.remove($),this._element.classList.remove(S),s.default.trigger(this._element,O)};this._element.classList.add($),this._queueCallback(t,this._element,this._config.animation)}dispose(){this._clearTimeout(),this._element.classList.contains(S)&&this._element.classList.remove(S),super.dispose()}_getConfig(t){return t={...D,...o.default.getDataAttributes(this._element),..."object"==typeof t&&t?t:{}},u(v,t,this.constructor.DefaultType),t}_maybeScheduleHide(){this._config.autohide&&(this._hasMouseInteraction||this._hasKeyboardInteraction||(this._timeout=setTimeout((()=>{this.hide()}),this._config.delay)))}_onInteraction(t,e){switch(t.type){case"mouseover":case"mouseout":this._hasMouseInteraction=e;break;case"focusin":case"focusout":this._hasKeyboardInteraction=e}if(e)return void this._clearTimeout();const n=t.relatedTarget;this._element===n||this._element.contains(n)||this._maybeScheduleHide()}_setListeners(){s.default.on(this._element,w,(t=>this._onInteraction(t,!0))),s.default.on(this._element,E,(t=>this._onInteraction(t,!1))),s.default.on(this._element,A,(t=>this._onInteraction(t,!0))),s.default.on(this._element,x,(t=>this._onInteraction(t,!1)))}_clearTimeout(){clearTimeout(this._timeout),this._timeout=null}static jQueryInterface(t){return this.each((function(){const e=I.getOrCreateInstance(this,t);if("string"==typeof t){if(void 0===e[t])throw new TypeError(`No method named "${t}"`);e[t](this)}}))}}return b(I),_(I),I}(a.exports,p.exports,l.exports)}(de);var ue,fe,he,pe=de.exports;ue=navigator.userAgent.toLowerCase().indexOf("webkit")>-1,fe=navigator.userAgent.toLowerCase().indexOf("opera")>-1,he=navigator.userAgent.toLowerCase().indexOf("msie")>-1,(ue||fe||he)&&document.getElementById&&window.addEventListener&&window.addEventListener("hashchange",(function(){var t,e=location.hash.substring(1);/^[A-z0-9_-]+$/.test(e)&&(t=document.getElementById(e))&&(/^(?:a|select|input|button|textarea)$/i.test(t.tagName)||(t.tabIndex=-1),t.focus())}),!1);var me={exports:{}};!function(t,e){var n;jQuery(document).ready((function(t){t(".navbar-toggler").addClass("collapsed")})),jQuery(".navbar-toggler").click((function(){jQuery(".open").toggleClass("hidden"),jQuery(".close").toggleClass("hidden")})),(n=window.jQuery)((function(){if(n("#gform_1").length||n("#gform_5").length||n("#gform_10").length||n("#gform_11").length||n("#gform_12").length||n("#gform_13").length||n("#gform_14").length||n("#gform_15").length||n("#gform_16").length||n("#gform_17").length||n("#gform_18").length||n("#gform_19").length||n("#gform_20").length||n("#gform_21").length||n("#gform_22").length||n("#gform_24").length||n("#gform_25").length){if(n("#gform_1").length||n("#gform_5").length||n("#gform_10").length||n("#gform_11").length||n("#gform_12").length||n("#gform_13").length||n("#gform_14").length||n("#gform_15").length||n("#gform_16").length||n("#gform_17").length||n("#gform_18").length||n("#gform_19").length||n("#gform_20").length||n("#gform_21").length||n("#gform_22").length||n("#gform_24").length||n("#gform_25").length)var t=n('<input type="button" id="hentadresseknapp" class="gform_button autofill_button" value="Gå videre" />');else n('html[lang="nb-NO"]').length&&(t=n('<input type="button" id="hentadresseknapp" class="gform_button autofill_button" value="Gå videre" />'));n(".ginput_container_phone").append(t),t.on("click",(function(t){t.preventDefault(),n(this).attr("disabled",!0),n("#gform_25").length?n("#gform_next_button_25_32").click():n(".gform_next_button").click()}))}})),jQuery(document).on("gform_page_loaded",(function(t,e,n){2==n&&(jQuery("#step1").hide(),jQuery(".gravity-forms").prepend("<div class='step2-outer'><p>Steg</p><img src='/wp-content/themes/betakaroten2.0/inc/gfx/steg_bestilling_02.svg' id='step2'></div>"),jQuery(".form-left").hide(),jQuery(".form-right2").show(),jQuery("#nedtelling-outer").hide())})),jQuery(".bestillbutton").click((function(){jQuery(".gravity-forms").addClass("animer")})),jQuery(".overvideo").click((function(t){t.stopPropagation(),jQuery("video").click()})),jQuery("video").click((function(){this.paused?(this.play(),jQuery(".overvideo-inner-content").hide()):(this.pause(),jQuery(".overvideo-inner-content").show())})),jQuery(document).ready((function(){jQuery(".s-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,autoplay:!0,autoplaySpeed:3e3}),jQuery(".beforeafter-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,dots:!0}),jQuery(".step-slider").slick({slidesToShow:1,slidesToScroll:1,arrows:!1,infinite:!1,cssEase:"linear"}),jQuery(".anm-anmeldelser").slick({slidesToShow:3,slidesToScroll:1,arrows:!0,infinite:!0,cssEase:"linear",prevArrow:'<div class="slick-prev"><img src="/wp-content/themes/betakaroten2.0/blocks/prodanmeldelser/img/ikon_pil.svg"></div>',nextArrow:'<div class="slick-next"><img src="/wp-content/themes/betakaroten2.0/blocks/prodanmeldelser/img/ikon_pil.svg"></div>',responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:1}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:1}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]})})),t.exports=function(t){t.fn.marquee=function(e){return this.each((function(){var n,i,s,o,r,a=t.extend({},t.fn.marquee.defaults,e),l=t(this),c=3,d="animation-play-state",u=!1,f=function(t,e,n){for(var i=["webkit","moz","MS","o",""],s=0;s<i.length;s++)i[s]||(e=e.toLowerCase()),t.addEventListener(i[s]+e,n,!1)},h=function(t){var e=[];for(var n in t)t.hasOwnProperty(n)&&e.push(n+":"+t[n]);return e.push(),"{"+e.join(",")+"}"},p=function(){l.timer=setTimeout(L,a.delayBeforeStart)},m={pause:function(){u&&a.allowCss3Support?n.css(d,"paused"):t.fn.pause&&n.pause(),l.data("runningStatus","paused"),l.trigger("paused")},resume:function(){u&&a.allowCss3Support?n.css(d,"running"):t.fn.resume&&n.resume(),l.data("runningStatus","resumed"),l.trigger("resumed")},toggle:function(){m["resumed"===l.data("runningStatus")?"pause":"resume"]()},destroy:function(){clearTimeout(l.timer),l.find("*").addBack().off(),l.html(l.find(".js-marquee:first").html())}};if("string"!=typeof e){var g;t.each(a,(function(t){if(void 0!==(g=l.attr("data-"+t))){switch(g){case"true":g=!0;break;case"false":g=!1}a[t]=g}})),a.speed&&(a.duration=parseInt(l.width(),10)/a.speed*1e3),o="up"===a.direction||"down"===a.direction,a.gap=a.duplicated?parseInt(a.gap):0,l.wrapInner('<div class="js-marquee"></div>');var _=l.find(".js-marquee").css({"margin-right":a.gap,float:"left"});if(a.duplicated&&_.clone(!0).appendTo(l),l.wrapInner('<div style="width:100000px" class="js-marquee-wrapper"></div>'),n=l.find(".js-marquee-wrapper"),o){var b=l.height();n.removeAttr("style"),l.height(b),l.find(".js-marquee").css({float:"none","margin-bottom":a.gap,"margin-right":0}),a.duplicated&&l.find(".js-marquee:last").css({"margin-bottom":0});var v=l.find(".js-marquee:first").height()+a.gap;a.startVisible&&!a.duplicated?(a._completeDuration=(parseInt(v,10)+parseInt(b,10))/parseInt(b,10)*a.duration,a.duration=parseInt(v,10)/parseInt(b,10)*a.duration):a.duration=(parseInt(v,10)+parseInt(b,10))/parseInt(b,10)*a.duration}else r=l.find(".js-marquee:first").width()+a.gap,i=l.width(),a.startVisible&&!a.duplicated?(a._completeDuration=(parseInt(r,10)+parseInt(i,10))/parseInt(i,10)*a.duration,a.duration=parseInt(r,10)/parseInt(i,10)*a.duration):a.duration=(parseInt(r,10)+parseInt(i,10))/parseInt(i,10)*a.duration;if(a.duplicated&&(a.duration=a.duration/2),a.allowCss3Support){var y=document.body||document.createElement("div"),w="marqueeAnimation-"+Math.floor(1e7*Math.random()),E="Webkit Moz O ms Khtml".split(" "),A="animation",x="",C="";if(void 0!==y.style.animation&&(C="@keyframes "+w+" ",u=!0),!1===u)for(var O=0;O<E.length;O++)if(void 0!==y.style[E[O]+"AnimationName"]){var T="-"+E[O].toLowerCase()+"-";A=T+A,d=T+d,C="@"+T+"keyframes "+w+" ",u=!0;break}u&&(x=w+" "+a.duration/1e3+"s "+a.delayBeforeStart/1e3+"s infinite "+a.css3easing,l.data("css3AnimationIsSupported",!0))}var j=function(){n.css("transform","translateY("+("up"===a.direction?b+"px":"-"+v+"px")+")")},k=function(){n.css("transform","translateX("+("left"===a.direction?i+"px":"-"+r+"px")+")")};a.duplicated?(o?a.startVisible?n.css("transform","translateY(0)"):n.css("transform","translateY("+("up"===a.direction?b+"px":"-"+(2*v-a.gap)+"px")+")"):a.startVisible?n.css("transform","translateX(0)"):n.css("transform","translateX("+("left"===a.direction?i+"px":"-"+(2*r-a.gap)+"px")+")"),a.startVisible||(c=1)):a.startVisible?c=2:o?j():k();var L=function(){if(a.duplicated&&(1===c?(a._originalDuration=a.duration,a.duration=o?"up"===a.direction?a.duration+b/(v/a.duration):2*a.duration:"left"===a.direction?a.duration+i/(r/a.duration):2*a.duration,x&&(x=w+" "+a.duration/1e3+"s "+a.delayBeforeStart/1e3+"s "+a.css3easing),c++):2===c&&(a.duration=a._originalDuration,x&&(w+="0",C=t.trim(C)+"0 ",x=w+" "+a.duration/1e3+"s 0s infinite "+a.css3easing),c++)),o?a.duplicated?(c>2&&n.css("transform","translateY("+("up"===a.direction?0:"-"+v+"px")+")"),s={transform:"translateY("+("up"===a.direction?"-"+v+"px":0)+")"}):a.startVisible?2===c?(x&&(x=w+" "+a.duration/1e3+"s "+a.delayBeforeStart/1e3+"s "+a.css3easing),s={transform:"translateY("+("up"===a.direction?"-"+v+"px":b+"px")+")"},c++):3===c&&(a.duration=a._completeDuration,x&&(w+="0",C=t.trim(C)+"0 ",x=w+" "+a.duration/1e3+"s 0s infinite "+a.css3easing),j()):(j(),s={transform:"translateY("+("up"===a.direction?"-"+n.height()+"px":b+"px")+")"}):a.duplicated?(c>2&&n.css("transform","translateX("+("left"===a.direction?0:"-"+r+"px")+")"),s={transform:"translateX("+("left"===a.direction?"-"+r+"px":0)+")"}):a.startVisible?2===c?(x&&(x=w+" "+a.duration/1e3+"s "+a.delayBeforeStart/1e3+"s "+a.css3easing),s={transform:"translateX("+("left"===a.direction?"-"+r+"px":i+"px")+")"},c++):3===c&&(a.duration=a._completeDuration,x&&(w+="0",C=t.trim(C)+"0 ",x=w+" "+a.duration/1e3+"s 0s infinite "+a.css3easing),k()):(k(),s={transform:"translateX("+("left"===a.direction?"-"+r+"px":i+"px")+")"}),l.trigger("beforeStarting"),u){n.css(A,x);var e=C+" { 100%  "+h(s)+"}",d=n.find("style");0!==d.length?d.filter(":last").html(e):t("head").append("<style>"+e+"</style>"),f(n[0],"AnimationIteration",(function(){l.trigger("finished")})),f(n[0],"AnimationEnd",(function(){L(),l.trigger("finished")}))}else n.animate(s,a.duration,a.easing,(function(){l.trigger("finished"),a.pauseOnCycle?p():L()}));l.data("runningStatus","resumed")};l.on("pause",m.pause),l.on("resume",m.resume),a.pauseOnHover&&(l.on("mouseenter",m.pause),l.on("mouseleave",m.resume)),u&&a.allowCss3Support?L():p()}else t.isFunction(m[e])&&(n||(n=l.find(".js-marquee-wrapper")),!0===l.data("css3AnimationIsSupported")&&(u=!0),m[e]())}))},t.fn.marquee.defaults={allowCss3Support:!0,css3easing:"linear",easing:"linear",delayBeforeStart:1e3,direction:"left",duplicated:!1,duration:5e3,speed:0,gap:20,pauseOnCycle:!1,pauseOnHover:!1,startVisible:!1}}(i.default),jQuery((function(){if(jQuery(window).width()<960)var t=5e3;else t=1e4;jQuery(".marqueebanner").marquee({duration:t,gap:1,delayBeforeStart:0,direction:"left",duplicated:!0}),jQuery(".cur-visit").html(Math.floor(21*Math.random()+110)),setInterval((function(){var t=Math.floor(21*Math.random()+110);jQuery(".cur-visit").html(t)}),8e3);for(var e=document.getElementsByTagName("img"),n=0;n<e.length;n++)e[n].onmouseover=function(){this.style.cursor="hand",this.style.borderColor="red"},e[n].onmouseout=function(){this.style.cursor="pointer",this.style.borderColor="grey"};if(jQuery(".product-carousel__thumbnail").on("click",(function(){jQuery(".aktiv").removeClass(),jQuery(this).find("img").addClass("aktiv")})),document.body.classList.contains("page-id-524")){const t=document.querySelector(".forsidehoved-content h1");if(t){const e=document.createElement("div");e.innerHTML="<p class='heart'><i class='fa fa-heart fa-4x fa-beat'></i></p>",t.parentNode.insertBefore(e,t)}}})),document.addEventListener("DOMContentLoaded",(t=>{setTimeout((()=>{document.body.classList.contains("page-id-524")||(document.getElementById("popup").style.display="flex")}),4e3),document.querySelector(".close-button").addEventListener("click",(function(){document.getElementById("popup").style.display="none"}))}))}(me),t.Alert=d,t.Button=f,t.Carousel=g,t.Collapse=b,t.Dropdown=Gt,t.Modal=Jt,t.Offcanvas=ee,t.Popover=oe,t.Scrollspy=ae,t.Tab=ce,t.Toast=pe,t.Tooltip=se,t.__moduleExports=me.exports,Object.defineProperty(t,"__esModule",{value:!0})}));
